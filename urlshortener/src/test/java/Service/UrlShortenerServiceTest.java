...
public class UrlShortenerServiceTest {
        ...
        void returnsExistingShortCodeWhenUrlAlreadyExist()
    {
        ...
        UrlMappingRepository repository = mock(UrlMappingRepository.class); // Creates the fake repository.
    ...
    // Act: call createOrGetShortCode(...)
        String result = service.createOrGetShortCode(originalUrl);
        log.info(result); // Check if this returns abc123XYZ
